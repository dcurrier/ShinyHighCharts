...
#'
#' @export
highchartsOutput <- function(inputId, width="100%", height="400px", type=c("heatmap") ) {
  ...
  tagList(
    ...
    singleton(tags$head(tags$script(src="shinyhighcharts/Highcharts-4.0.3/js/modules/no-data-to-display.js"))),
    JS,
